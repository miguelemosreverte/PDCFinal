 ...
 */
@WebServlet("/validar_nro_chasis.jsp")
public class ValidarNroChasis extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ValidarNroChasis() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
				String res = ValidarNroChasisDB.validarNroChasis(request.getParameter("nro_chasis"));
