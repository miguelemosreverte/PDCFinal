	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td colspan="5">
					<input type="text" name="tipo_documento" value="<%= tipoDoc.getTipoDocumento() %>" maxlength="100" size="40" />
				</td>
			</tr>
			<tr>
				<th width="20%" class="ar">M&aacute;scara:</th>
				<td>
					<input type="text" name="mascara" value="<%= tipoDoc.getMascara() %>" maxlength="50" size="40"/>
				</td>
